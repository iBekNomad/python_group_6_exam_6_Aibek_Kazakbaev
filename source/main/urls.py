...
from webapp.views import index_view, guestbook_view, guestbook_create_view, guestbook_delete_view, guestbook_update_view

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', index_view, name='index'),
    path('guestbook/<int:pk>/', guestbook_view, name='guestbook_view'),
